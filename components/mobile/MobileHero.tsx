          ...
          >
            ...
            <div className="flex flex-col gap-2.5">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-[#facc15] text-[#0a0a0a] font-bold text-[14px] tracking-wider uppercase px-6 py-[12px] hover:bg-yellow-400 active:bg-yellow-500 active:scale-[0.98] transition-all duration-150 cursor-pointer"
              >
                {slide.cta}

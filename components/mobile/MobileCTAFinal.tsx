  ...
  return (
    <section className="bg-[#facc15] py-16 px-5">
      <div className="bg-[#0a0a0a] p-8 shadow-2xl relative overflow-hidden">
        ...
        {/* Headline */}
        <h2 className="font-display text-white uppercase leading-[1.05] mb-4 relative z-10 text-center"
        ...
        <div className="flex flex-col gap-3 relative z-10">
          ...
          <a href="https://wa.link/ocm4yr"
             ...
             className="w-full inline-flex items-center justify-center gap-2
                        ...
                        text-[15px] tracking-wider uppercase px-6 py-[16px]
                        hover:border-[#facc15] hover:text-[#facc15] active:bg-white/5 transition-all">

...
export function EquiposCarousel() {
  ...
  return (
    <section ref={ref} className="relative min-h-[85vh] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 min-h-[85vh] flex items-start md:items-center justify-start md:justify-end px-5 md:px-12 lg:px-20 pt-[100px] md:pt-0 pb-[90px] md:pb-0">

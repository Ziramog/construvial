...
export function EquiposCarousel() {
  ...
  return (
    <section ref={ref} className="relative min-h-[85vh] md:min-h-screen overflow-hidden">
      ...
      {/* Dark overlay — gradient from right on desktop, left on mobile */}
      <div className="absolute inset-0 bg-gradient-to-r md:bg-gradient-to-l from-black/85 via-black/60 to-black/30" />

      {/* Content */}
      <div className="relative z-10 min-h-[85vh] md:min-h-screen flex items-start md:items-center justify-start md:justify-end px-5 md:px-12 lg:px-20 pt-[100px] md:pt-0 pb-[90px] md:pb-0">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="flex flex-col items-start md:items-end lg:col-span-1 text-left md:text-right"
          >
            <motion.div
              initial={{ width: 0 }}
              animate={isInView ? { width: 64 } : {}}
              transition={{ duration: 0.5, ease: "easeOut", delay: 0.4 }}
              className="hidden md:block h-1 bg-[#facc15] mb-6 md:ml-auto"
            />
            ...
            <p className="font-body text-[#facc15] text-[14px] md:text-xs tracking-[1.5px] md:tracking-[0.3em] font-semibold md:font-bold uppercase opacity-85 mb-[12px] md:mb-4">
              <span className="md:hidden">Equipos propios</span>
              <span className="hidden md:inline">40+ equipos propios, listos para operar</span>
            </p>
            ...
            <h2 className="font-display text-white uppercase text-[36px] md:text-[clamp(48px,6vw,80px)] font-[800] md:font-normal leading-[1.1] md:leading-none max-w-[85%] md:max-w-none mb-4 md:mb-8">
              <span className="md:hidden">LISTOS PARA<br/><span className="text-[#facc15] block">OPERAR</span></span>
              <span className="hidden md:inline">Equipos<br/><span className="text-[#facc15]">listos para operar</span></span>
            </h2>
            ...
            <p className="font-body text-white/70 text-[14px] md:text-[17px] leading-[1.4] md:leading-relaxed max-w-[85%] md:max-w-lg mb-6 md:mb-10">
              <span className="md:hidden">Disponibilidad inmediata.</span>

...
export function ServicesCards() {
  return (
    <section className="relative bg-[#0a0a0a] py-24 px-6">
      {/* Smooth transition FROM the yellow stats section above */}
      <div className="absolute top-0 inset-x-0 h-24 bg-gradient-to-b from-[#f5f5f4] to-transparent pointer-events-none" />
